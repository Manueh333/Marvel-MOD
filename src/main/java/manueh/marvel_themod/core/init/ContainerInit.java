...
public class ContainerInit {
    ...
    public static final RegistryObject<MenuType<InfinityGauntletContainer>> INFINITY_GAUNTLET_CONTAINER = CONTAINERS.register("infinity_gauntlet_container", () -> IForgeMenuType.create(InfinityGauntletContainer::new));
